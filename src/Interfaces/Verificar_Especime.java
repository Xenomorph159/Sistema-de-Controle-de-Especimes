 ...
 * @author 08050503
 */
public class Verificar_Especime extends javax.swing.JFrame {

    private int codigo;

    /**
     * Creates new form Verificar_Especime1
     */
    public Verificar_Especime() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel3.setText("VERIFICAR ESPÉCIME");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if (Classes.EspecimeDAO.getInstance().pesquisar(codigo) != null) {
            JOptionPane.showMessageDialog(this, Classes.EspecimeDAO.getInstance().pesquisar(codigo));
        } else {
            JOptionPane.showMessageDialog(this, "Não foi possivel verificar, verifique os dados!", "ERRO", JOptionPane.WARNING_MESSAGE);
        }
        dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Verificar_Especime.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Verificar_Especime().setVisible(true);
            }
        });
    }
